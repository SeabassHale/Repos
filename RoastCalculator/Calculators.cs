...
namespace RoastCalculator
{
    internal class Calculators
    {
        ...
        //    if (dish.Name == "Pork")
        //    {
        //        dish.CookTime = dish.CookTime * weight;
        //        dish.CookTime += dish.ExtraCookTime;
        //        cookingTimeAlarms.Add(dish.CookTime);
        ...
        {
            // Calculate Total Cooking Time for Meal
        ...
        public static void MainServingTimeCalculator()
        {
            // Receives 
        }
