...
namespace WritingFunctions
{
    internal class Program
    {
        ...
        /// <summary>
        /// Pass a 32-bit integer and it will be converted in to its ordinal
        /// </summary>
        ...
        static void RunCardinalToOrdinal()
        {
            for (int i = 1; i <= 40; i++)
            {
                //These two lines do the same thing, but are less tidy
                //string number = CardinalToOrdinal(number: i); 
                //Write($"{number}, ");
